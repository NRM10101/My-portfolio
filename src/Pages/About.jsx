    ...
    return (
        <section className='max-container'>
            <h1 className='head-text'>
                Hello, I'm <span className='blue-gradient_text font-semibold drop-shadow'>NRM</span>
            </h1>
            <div className='mt-5 flex flex-col gap-3 text-slate-500 '>
                <p>
                    Computer Science Undergratuate from University of Moratuwa,
            ...
            <div className='py-16'>
                ...
                <div className='mt-5 flex flex-col gap-3 text-slate-500 '>
                    <p>
                        I've worked with all sort of companies , leveling up my skills
                                    ...
                                    <div>
                                        ...
                                        <ul className='my-5 list-disc ml-5 space-y-2'>
                                            {experience.points.map((point, index) => (
                                                <li key={`experience-point-${index}`} className='text-black-500/50 font-norml pl-1 text-sm'>
                                                    {point}
                                                </li>
                                            ))}
